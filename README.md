...
code/      Python scripts used for the simulations, microphone-pair selection methods, and figure generation.
data/      Input datasets and room impulse responses.
results/   Output files (.npy) generated by the simulations and used to reproduce the figures in the paper.
